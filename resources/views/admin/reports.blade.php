        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <form method="GET" action="{{ route('admin.reports') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('admin.reports') }}" class="flex-1 inline-flex items-center justify-center bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors text-sm font-medium">
                        Limpar
                    </a>
                </div>
            </form>
